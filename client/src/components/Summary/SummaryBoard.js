...
import Tasks from "../CustomLayout/components/Tasks/Tasks.jsx";
import CustomTabs from "../CustomLayout/components/CustomTabs/CustomTabs.jsx";
import Card from "../CustomLayout/components/Card/Card.jsx";
import CardHeader from "../CustomLayout/components/Card/CardHeader.jsx";
import CardIcon from "../CustomLayout/components/Card/CardIcon.jsx";
...
class SummaryBoard extends React.Component {
  state = {
    value: 0
  };
          ...
          <GridItem xs={12} sm={6} md={3}>
            <Card>
              <CardHeader color="warning" stats icon>
                ...
                <p className={classes.cardCategory}>블로그 포스트</p>
          ...
          <GridItem xs={12} sm={6} md={3}>
            <Card>
              <CardHeader color="success" stats icon>
                ...
                <p className={classes.cardCategory}>등록 도서 수</p>
          ...
          <GridItem xs={12} sm={6} md={3}>
            <Card>
              <CardHeader color="danger" stats icon>
                ...
                <p className={classes.cardCategory}>방문자 수</p>
                <h3 className={classes.cardTitle}>1,000</h3>
              </CardHeader>
              <CardFooter stats>
                <div className={classes.stats}>
                  <LocalOffer />
          ...
          <GridItem xs={12} sm={6} md={3}>
            <Card>
              <CardHeader color="info" stats icon>
                ...
                <p className={classes.cardCategory}>나의 친구</p>
                <h3 className={classes.cardTitle}>+0</h3>
              </CardHeader>
              <CardFooter stats>
                <div className={classes.stats}>
...
export default withStyles(dashboardStyle)(SummaryBoard);
