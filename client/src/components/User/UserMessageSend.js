...
class UserMessageSend extends React.Component {
    ...
    render(){
        ...
        const { messageList, rowsPerPage, page, selected } = this.state;
                    ...
                    <Paper className={classes.root}>
                        ...
                        <Table className={classes.table}>
                            ...
                            {messageList.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map(row => {
                                ...
                                return (
                                <TableRow key={row._id} className={classNames((row.isRead || row.receiverEmail !==this.props.auth.email) && classes.alreadRead, classes.item)} onClick={()=>this.props.history.push('/dashboard/message/detail/'+original_id)}>
                                    <TableCell >
                                    {row.ins_dtime}
                                    </TableCell>
...
export default connect(mapStateToProps)(withStyles(styles)(UserMessageSend));